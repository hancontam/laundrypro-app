...
function TabItem({ icon: Icon, label, focused, }) {
  return (<View className="items-center justify-center gap-1" style={{ width: 64 }}>
    ...
    <Text numberOfLines={1} ellipsizeMode="tail" className={`text-[10px] font-bold ${focused ? "text-indigo-600" : "text-slate-400"}`} style={{ width: "100%", textAlign: "center" }}>
      {label}
    </Text>
  </View>);
}

...
function TabItem({ icon: Icon, label, focused }) {
  return (
    <View className="items-center justify-center gap-1" style={{ width: 64 }}>
      <View
      ...
      <Text
        numberOfLines={1}
        ellipsizeMode="tail"
        className={`text-[10px] font-bold ${focused ? "text-indigo-600" : "text-slate-400"}`}
        ...
        <View className="mb-6 flex-row flex-wrap gap-3">
          ...
          <View className="w-[48%]">
            <ShortcutCard
              ...
              onPress={() =>
                navigation.navigate("OrdersTab", { screen: "OrderList" })
              }
            />
          </View>
          ...
          {isStaffOrAdmin && (
            <View className="w-[48%]">
              <ShortcutCard
                icon={UsersThree}
                title="Quản trị"
                subtitle="Khách hàng, thanh toán và các công cụ quản lý phù hợp với quyền của bạn."

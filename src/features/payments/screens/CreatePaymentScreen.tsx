// src/features/payments/screens/CreatePaymentScreen.tsx
...
type Props = {
  navigation: NativeStackNavigationProp<MainStackParamList, "CreatePayment">;
  route: RouteProp<MainStackParamList, "CreatePayment">;
};
...
export default function CreatePaymentScreen({ navigation, route }: Props) {

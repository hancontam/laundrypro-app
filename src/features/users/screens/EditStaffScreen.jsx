...
export default function EditStaffScreen({ navigation, route }) {
    ...
    const handleSave = useCallback(async () => {
        ...
        const result = await dispatch(updateStaffThunk({
            id: staffId,
            payload: {
                name: name.trim(),
                email: email.trim(),
          ...
          <View>
            ...
            <View className="mb-6">
              ...
              <View className="flex-row items-center rounded-xl border border-slate-200 bg-slate-100 px-3">
                ...
                <TextInput className="ml-3 flex-1 py-3.5 text-base font-medium text-slate-500" value={selectedUser?.phone || ''} editable={false}/>
              </View>
            ...
            <View className="mb-6">
              ...
              <View className="flex-row items-center rounded-xl border border-slate-200 bg-slate-50 px-3">
                ...
                <TextInput className="ml-3 flex-1 py-3.5 text-base font-medium text-slate-900" placeholder="Tên nhân viên" placeholderTextColor={Colors.slate400} value={name} onChangeText={setName}/>
              </View>
            </View>

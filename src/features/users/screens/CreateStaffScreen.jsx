        ...
        <ScrollView contentContainerStyle={layoutContainer} contentContainerClassName="px-6 pb-8" keyboardShouldPersistTaps="handled">
          ...
          <View className="mb-5">
            ...
            <View className="rounded-xl border border-slate-200 bg-slate-50 px-3">
              <TextInput className="py-3.5 text-base font-semibold text-slate-900" placeholder="0901234567" placeholderTextColor={Colors.slate300} keyboardType="phone-pad" value={phone} onChangeText={setPhone} autoFocus/>
            </View>
          </View>
          ...
          <View className="mb-5">
            ...
            <View className="rounded-xl border border-slate-200 bg-slate-50 px-3">
              <TextInput className="py-3.5 text-base font-semibold text-slate-900" placeholder="Nguyễn Văn A" placeholderTextColor={Colors.slate300} value={name} onChangeText={setName}/>
            </View>
          </View>
          ...
          <View className="mb-8">
            ...
            <View className="rounded-xl border border-slate-200 bg-slate-50 px-3">
              <TextInput className="py-3.5 text-base font-semibold text-slate-900" placeholder="staff@laundrypro.com" placeholderTextColor={Colors.slate300} keyboardType="email-address" autoCapitalize="none" value={email} onChangeText={setEmail}/>
            </View>
          </View>

// src/features/customerPayments/screens/PaymentDetailScreen.tsx
...
type Props = NativeStackScreenProps<any, "PaymentDetail">;
...
export default function PaymentDetailScreen({ navigation }: Props) {

        ...
        <ScrollView contentContainerStyle={layoutContainer} contentContainerClassName="px-6 pb-8 pt-2" keyboardShouldPersistTaps="handled">
          ...
          <View className="mb-6">
            ...
            <View className="flex-row items-center rounded-xl border border-slate-200 bg-slate-50 px-3">
              ...
              <TextInput className="ml-3 flex-1 py-3.5 text-base font-medium text-slate-900" placeholder="Nhập họ tên" placeholderTextColor={Colors.slate400} value={name} onChangeText={setName}/>
            </View>
          </View>
          ...
          <View className="mb-6">
            ...
            <View className="flex-row items-center rounded-xl border border-slate-200 bg-slate-50 px-3">
              ...
              <TextInput className="ml-3 flex-1 py-3.5 text-base font-medium text-slate-900" placeholder="Nhập email" placeholderTextColor={Colors.slate400} keyboardType="email-address" autoCapitalize="none" value={email} onChangeText={setEmail}/>
            </View>
          </View>
          ...
          <View className="mb-6">
            ...
            <View className="flex-row items-center rounded-xl border border-slate-200 bg-slate-50 px-3">
              ...
              <TextInput className="ml-3 flex-1 py-3.5 text-base font-medium text-slate-900" placeholder="Nhập địa chỉ của bạn" placeholderTextColor={Colors.slate400} value={address} onChangeText={setAddress}/>
            </View>
          </View>

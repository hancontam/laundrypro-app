...
export default function DashboardSkeleton() {
    return (<View className="flex-1">
      ...
      <View className="flex-row flex-wrap justify-between mb-6">
        {[1, 2, 3, 4].map((item) => (<View key={item} className="w-[48%] mb-4 rounded-2xl border border-slate-100 bg-white p-4" style={shadowCard}>
      ...
      {/* Charts Skeleton */}
      <View className="rounded-2xl border border-slate-100 bg-white p-4 mb-6" style={shadowCard}>
